...
imagemInimigoNivel3 = img`
    . 2 2 . . . f . . . f . . 2 2 . 
    . . 2 2 . f 2 f . f 2 f 2 2 . 2 
    . f . . f 2 2 f f f 2 f . f . . 
    f 2 f . f 2 2 2 2 2 2 f . 2 f . 
    f 4 f f 2 4 4 4 4 4 4 4 f 2 f . 
    f 4 f 2 4 4 5 5 5 5 4 4 4 4 f . 
    f 2 2 4 4 5 5 5 5 5 5 4 4 4 f 2 
    . f 4 4 5 5 4 5 5 4 5 5 4 f . 2 
    . f 4 4 5 5 4 5 5 4 4 5 4 f 2 . 
    f 2 f 4 5 5 5 5 5 5 5 5 4 f . . 
    f 4 f 4 5 5 5 5 5 5 5 5 4 2 f . 
    f 4 f 4 4 5 5 4 4 4 5 4 4 2 f . 
    . f 2 4 4 4 5 5 5 5 4 4 4 2 f 2 
    2 . f 2 4 4 4 4 4 4 4 4 2 f . 2 
    2 2 . f 2 4 4 4 4 4 2 2 f . 2 2 
...
imagemInimigoFerido = img`
    ...
    . . 2 2 . f 2 f . f 2 f 2 2 . 2 
    . f . . f 2 2 f f . 2 f . f . . 
    f 2 f . f 2 2 2 2 . 2 f . 2 f . 
    f 4 f f . . 4 4 . . 4 4 f 2 . . 
    . . f 2 4 4 . . . 5 4 4 4 4 . . 
    f . . 4 4 5 5 . 5 . . . 4 4 f 2 
    . . . 4 5 5 4 . 5 4 5 . . f . 2 
    . . 4 4 5 5 . 5 5 4 4 5 . f 2 . 
    f 2 f 4 5 5 . 5 5 5 5 5 . f . . 
    f 4 f 4 5 . . 5 5 5 5 . . 2 f . 
    f 4 . . . . 5 4 4 4 5 4 . 2 f . 
    . f 2 . . . . . . . 4 4 4 2 f 2 
    2 . f . 4 4 4 4 4 . . 4 2 f . 2 
    2 2 . f 2 4 4 4 4 4 2 . f . 2 2 
    . 2 . . f f f f f f f f . . 2 2 
    `
imagemInimigoAereo = img`
    ...
    . . . . f d 2 c c 2 d f . . . . 
    . . . f c f 2 c c 2 f c f . . . 
    . . f c c f c c c c f c c f f . 
    . f c c c b f c c f b c c c f . 
    . f c c b b f c c f b b c c f . 
    f c c b b c c c c c c b b c c f 
    f c c b c c c c c c c c b c c f 
    f c c f c c f c c f c c f c c f 
    f c f . f c f c c f c f . f c f 
    . f . . . f f b b f f . . . f . 
    . . . . . . . f f . . . . . . . 
    `
